...
| ([Отчет по модернизации образовательных программ]https://github.com/lobanovmikh/Projects/blob/master/Karpov/Final_proj_var1.ipynb)  | Ряд задач по по исследованию мобильного приложения | Данные мобильного приложения | Pandas, Numpy, Seaborn, Scipy  | EDA, Hypothesis testing, Bootstrap, A/B testing, Nonparametric tests |
